...
No new releases as of 3/4 — latest version remains v2.1.63 (2/28).
...
- **v2.1.63 remains latest**: No new releases as of 3/4. Update with `brew upgrade --cask claude-code` if you haven't already.
